...
function startCountdown() {
    setInterval(() => {
        const now = new Date();
        const dayNumber = getDayOfYearFromMonthAndDay(3, 15); // may, 12 => 13-may
